...
>
  <div className="bg-black/70 w-full h-full absolute top-0 left-0 z-0"></div>
      <div className="relative z-10 text-center px-6">
        <h2 className="text-white font-semibold md:text-[30px] text-xl mb-4 capitalize">
        ...
        <div className="flex w-full max-w-6xl justify-center mt-8">
          <div className="bg-teal-700 rounded-t text-white font-semibold py-2 px-6 text-base">
            Pg & Rooms {/* bg-gradient-to-r from-blue-400 to-blue-300 */}
          </div>
        </div>
        ...
        <div className="flex items-center  max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl mx-auto p-2 md:p-6 bg-white rounded-full shadow-lg">
          ...
          <div className=" md:block hidden">
            <button className="flex  items-center bg-teal-700 hover:bg-teal-600 text-white text-sm md:text-base py-2 px-1 md:px-5 rounded-full">
